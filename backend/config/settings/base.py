...
TEMPLATES = [
    {
        ...
        "DIRS": [
            BASE_DIR / 'CONFIG/properties',  # Fixed the syntax error with proper quotes
        ],
        "APP_DIRS": True,  # Automatically load properties from app directories
        "OPTIONS": {
            "context_processors": [
